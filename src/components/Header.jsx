      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-28">
          <div className="flex justify-between items-center h-16">
            <NavLink
              to="/"
              className="text-xl font-bold font-heading text-coffee"
              onClick={closeMenu}
            >
              Shayam Cafe
            </NavLink>
            ...
            <ul className="hidden md:flex items-center space-x-6 font-body">
              ...
              >
                ...
                {dropdownOpen && (
                  <ul className="absolute w-44 bg-cream border rounded-md mt-0 p-2 space-y-1 shadow-lg z-50">
                    <li>
                      <NavLink
                        to="/menu/juices"
                        className="block px-4 py-1 text-charcoal hover:text-white hover:bg-peach rounded-md"
                      >
                        Juices
                      </NavLink>
                    </li>
              ...
              <li>
                <NavLink
                  to="/gallery"
                  className="text-charcoal hover:text-berry"
                >
                  Gallery
                </NavLink>
              </li>
