    ...
    <main className="bg-cream min-h-screen pt-28">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold text-charcoal">
          Get in <span className="text-peach">Touch</span>
        </h1>
        <p className="text-coffee mt-4 text-base md:text-lg leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-6 pb-20">
        {/* Contact Info */}
        <div className="space-y-8 text-coffee">
          <div>
        ...
        <form
          ...
          className="space-y-4 bg-orange-200 p-6 rounded-lg border border-grayMid/30"
        >
          <input
            type="text"
            name="name"
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-orange-300 to-coffee w-full text-white font-semibold px-6 py-3 rounded hover:opacity-90 transition"
          >
            Send Message →
          </button>
        </form>
      ...
      {/* CTA */}
      <motion.section
        className="text-center px-6 pb-16 text-coffee"
        initial={{ opacity: 0, y: 40 }}
